...
def extract_imgs(fname, fpref, doc):
    ...
    t0 = time.clock()
    if not (fname and fpref and doc):
...
if __name__ == "__main__":
    fname = "/home/jan/Documents/test/Еты-Пуровское/260по/ОПИСАНИЕ+ФОТО/Рис._2.2.7-2.2.10_Еты-Пуровское_260.pdf"
    doc = fitz.open(fname)
    extract_imgs(doc=doc, fpref="pdfimg", fname=fname)
